...
<div class="container">
    <div class="card my-4">
        <div class="card-body">
            ...
            <form class="mt-5 col-md-6" method="POST" action="/colleges/{{ $college->id }}">
            @method('put')
            @csrf
                <div class="form-group">
                    <label for="nama_kampus">Nama Universitas</label><span style="color: red">*</span>
                    <input type="text" class="form-control @error('nama_kampus') is-invalid @enderror" id="nama_kampus" name="nama_kampus" placeholder="Masukkan nama universitas" value="{{ $college->nama_kampus }}">
                    @error('nama_kampus')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('peringkat_asia') is-invalid @enderror" id="peringkat_asia" name="peringkat_asia" placeholder="Masukkan peringkat di Asia" value="{{ $college->peringkat_asia }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('peringkat_lokal') is-invalid @enderror" id="peringkat_lokal" name="peringkat_lokal" placeholder="Masukkan peringkat di Indonesia" value="{{ $college->peringkat_lokal }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" placeholder="Masukkan lokasi universitas" value="{{ $college->lokasi }}">
                    @error('lokasi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
